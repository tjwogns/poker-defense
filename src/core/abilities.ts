...
export const SUIT_POWER_DEFS: Record<Suit, SuitPowerDef> = {
  S: { suit: 'S', name: '사신의 칼날', description: '모든 적 현재 HP 비례 피해', glyph: SUIT_GLYPHS.S, color: 0xb9c2d0, key: 'Q' },
  H: { suit: 'H', name: '여왕의 자비', description: '최근 일반 적 최대 6기 퇴장', glyph: SUIT_GLYPHS.H, color: 0xe56b72, key: 'W' },
  D: { suit: 'D', name: '황금비', description: '라운드 비례 즉시 골드', glyph: SUIT_GLYPHS.D, color: 0xe6c84f, key: 'R' },
